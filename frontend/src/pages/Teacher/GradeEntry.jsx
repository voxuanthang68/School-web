    ...
    <div>
      ...
      <div className="page-header">
        <div>
          ...
          <p>
            {classInfo?.subject_name} | {classInfo?.semester_name} ({classInfo?.semester_year})
          </p>
            ...
            {(grades || []).map(g => (
              <tr key={g.student_id}>
                ...
                <td style={{ fontWeight: 700 }}>
                  {g.final_score_10 != null ? g.final_score_10 : '-'}
                </td>
                ...
                <td>
                  {g.is_pass != null && (
                    <span
                      className={`badge ${
                        g.is_pass ? 'badge-success' : 'badge-danger'
                      }`}
                    >e
                      {g.is_pass ? 'Đậu' : 'Rớt'}
                    </span>
